...
class MtoE1(torch.nn.Module):
    def __init__(self):
        super(MtoE1, self).__init__()
    ...
    def load(cls):
        ...
        try:
            ...
            print(f'No trained model found with the name "MtoE1". Creating a new model')
        return model